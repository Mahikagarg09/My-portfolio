...
export default function About() {
  return (
    <section id="about">
      <div className="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center pl-0 md:px-20">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font text-6xl sm:text-4xl text-3xl mb-4 font-medium text-white">
            Hi, I'm Mahika Garg.
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 pl-24">
          <img
